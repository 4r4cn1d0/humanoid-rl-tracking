#!/usr/bin/env python3
"""
Launch the official FetchReachDense-v3 environment from Gymnasium-Robotics.
No modifications, no wrappers - pure official environment.

NOTE: Version 1.3.1 has a known bug where the robot is misplaced.
This is fixed in v4 (unreleased) which requires Python 3.10+
"""
...
print("=" * 60)
print("OFFICIAL FetchReachDense-v3 Environment")
print("=" * 60)
print("Pure Gymnasium-Robotics environment - no modifications")
print("WARNING: v3 has a known positioning bug (robot misplaced)")
print("Fixed in v4 which requires Python 3.10+")
